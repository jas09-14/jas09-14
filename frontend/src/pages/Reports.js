          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-border/50">
              ...
              <span className="font-mono font-semibold text-foreground">
                {formatBRL(summary?.total_planned || 0)}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-border/50">
              <span className="text-muted-foreground">Total Realizado</span>
              <span className="font-mono font-semibold text-foreground">
                {formatBRL(summary?.total_actual || 0)}
              </span>
            </div>
            <div className="flex justify-between items-center py-2">
              ...
              >
                ...
                {formatBRL(Math.abs((summary?.total_planned || 0) - (summary?.total_actual || 0)))}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border/50 p-6 shadow-soft">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-border/50">
              ...
              <span className="font-mono font-semibold text-foreground">
                {formatBRL((summary?.total_planned || 0) / 12)}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-border/50">
              <span className="text-muted-foreground">Média Realizada</span>
              <span className="font-mono font-semibold text-foreground">
                {formatBRL((summary?.total_actual || 0) / 12)}
              </span>
            </div>
            <div className="flex justify-between items-center py-2">
              <span className="text-muted-foreground">Variação Média</span>
              <span className="font-mono font-semibold text-muted-foreground">
                {formatBRL((Math.abs((summary?.total_planned || 0) - (summary?.total_actual || 0)) / 12))}
              </span>
            </div>
          </div>
        </div>
